...
namespace ArcGISEX3
{
    public partial class ShowFeatureInfo : Form
    {
        ...
        public void showAttribute(IFeature feature)
        {
            ...
            for (i = 0; i < num; i++)
            {
                ...
                else
                {
                    ...
                    picturePath = feature.Value[5].ToString();
                }
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //ILayer Layer = Form1.form1.axMapControl1.get_Layer(0);
            //featureLayer = layer as FeatureLayer;
            //ISpatialFilter spatialFilter = new SpatialFilterClass();
            //IFeatureCursor featureCursor = featureLayer.Search(spatialFilter, false);
            //IFeature feature = featureCursor.NextFeature();
            //picturePath = feature.Value[6].ToString();
            //picturePath = dataGridView1[0, 1].Value as string;

            Form pictureForm = new PictureForm(picturePath);
            pictureForm.Show();
        }
    }
}
